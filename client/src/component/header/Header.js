...
const Header = ({ Privacy }) => {
  ...
  const [hoverRef, isHovering] = useHover(200, 200);
  return (
    <>
      <Sound />
      ...
      <StyledFixed>
        <StyledLinkBox>
          ...
          <StyledLink>
            <a ref={hoverRef} href="https://www.facebook.com/OnceUponATimeAPP">
              {isHovering ? (
                <Icon
                  type="facebook"
                  theme="filled"
                  style={{ fontSize: "30px", paddingTop: "5px", color: "#08c" }}
                />
              ) : (
                <Icon
                  type="facebook"
